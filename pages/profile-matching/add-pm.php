  ...
  $response = [
      ...
      'message' => 'Semua data harus diisi lengkap'
        ...
        if ($konek->query($save_nilai_murni) === TRUE) {
            ...
            while ($u = mysqli_fetch_assoc($data_target_badminton)) {
                $target_badminton[] = $u;
            }
            ...
            if ($cek_result->num_rows > 0) {
                ...
                for ($i = 0; $i < count($data_nilai); $i++) {
                   ...
                   // Deklarasi variabel untuk setiap ekstrakurikuler
                ...
                $total_bobot_karakteristik_nsf_bela_diri_matahari = 0;
                   ...
                   // Mulai proses foreach untuk memproses data_bobot
    foreach ($data_bobot as $item) {
    // Cek untuk Minat dan NCF
    ...
    // Cek untuk Kemampuan dan NCF
    if ($item['nama_kriteria'] == 'Kemampuan' && $item['faktor'] == 'NCF') {

        $jumlah_ncf_kemampuan++;
        
    // Jumlahkan bobot sesuai kolom untuk kategori Kemampuan NCF
    $total_bobot_kemampuan_ncf_rohis += $item['bobot_rohis'] ?? 0;
    $total_bobot_kemampuan_ncf_paskibra += $item['bobot_paskibra'] ?? 0;
    $total_bobot_kemampuan_ncf_pmr += $item['bobot_pmr'] ?? 0;
    $total_bobot_kemampuan_ncf_pramuka += $item['bobot_pramuka'] ?? 0;
    $total_bobot_kemampuan_ncf_kabar_15 += $item['bobot_kabar_15'] ?? 0;
    $total_bobot_kemampuan_ncf_kir += $item['bobot_kir'] ?? 0;
    $total_bobot_kemampuan_ncf_japanese_club += $item['bobot_japanese_club'] ?? 0;
    $total_bobot_kemampuan_ncf_osis += $item['bobot_osis'] ?? 0;
    $total_bobot_kemampuan_ncf_basket += $item['bobot_basket'] ?? 0;
    $total_bobot_kemampuan_ncf_badminton += $item['bobot_badminton'] ?? 0;
    $total_bobot_kemampuan_ncf_voli += $item['bobot_voli'] ?? 0;
    $total_bobot_kemampuan_ncf_sepak_bola += $item['bobot_sepak_bola'] ?? 0;
    $total_bobot_kemampuan_ncf_futsal += $item['bobot_futsal'] ?? 0;
    $total_bobot_kemampuan_ncf_seni_suara += $item['bobot_seni_suara'] ?? 0;
    $total_bobot_kemampuan_ncf_tari_saman += $item['bobot_tari_saman'] ?? 0;
    $total_bobot_kemampuan_ncf_tari_lenggang_cisadane += $item['bobot_tari_lenggang_cisadane'] ?? 0;
    $total_bobot_kemampuan_ncf_teater += $item['bobot_teater'] ?? 0;
    $total_bobot_kemampuan_ncf_taekwondo += $item['bobot_taekwondo'] ?? 0;
    $total_bobot_kemampuan_ncf_canda_birawa += $item['bobot_canda_birawa'] ?? 0;
    $total_bobot_kemampuan_ncf_bela_diri_matahari += $item['bobot_bela_diri_matahari'] ?? 0;
    }

    // Cek untuk Kemampuan dan NSF
    elseif ($item['nama_kriteria'] == 'Kemampuan' && $item['faktor'] == 'NSF') {

        
        $jumlah_nsf_kemampuan++;
        
        $total_bobot_kemampuan_nsf_rohis += $item['bobot_rohis'] ?? 0;
        $total_bobot_kemampuan_nsf_paskibra += $item['bobot_paskibra'] ?? 0;
        $total_bobot_kemampuan_nsf_pmr += $item['bobot_pmr'] ?? 0;
        $total_bobot_kemampuan_nsf_pramuka += $item['bobot_pramuka'] ?? 0;
        $total_bobot_kemampuan_nsf_kabar_15 += $item['bobot_kabar_15'] ?? 0;
        $total_bobot_kemampuan_nsf_kir += $item['bobot_kir'] ?? 0;
        $total_bobot_kemampuan_nsf_japanese_club += $item['bobot_japanese_club'] ?? 0;
        $total_bobot_kemampuan_nsf_osis += $item['bobot_osis'] ?? 0;
        $total_bobot_kemampuan_nsf_basket += $item['bobot_basket'] ?? 0;
        $total_bobot_kemampuan_nsf_badminton += $item['bobot_badminton'] ?? 0;
        $total_bobot_kemampuan_nsf_voli += $item['bobot_voli'] ?? 0;
        $total_bobot_kemampuan_nsf_sepak_bola += $item['bobot_sepak_bola'] ?? 0;
        $total_bobot_kemampuan_nsf_futsal += $item['bobot_futsal'] ?? 0;
        $total_bobot_kemampuan_nsf_seni_suara += $item['bobot_seni_suara'] ?? 0;
        $total_bobot_kemampuan_nsf_tari_saman += $item['bobot_tari_saman'] ?? 0;
        $total_bobot_kemampuan_nsf_tari_lenggang_cisadane += $item['bobot_tari_lenggang_cisadane'] ?? 0;
        $total_bobot_kemampuan_nsf_teater += $item['bobot_teater'] ?? 0;
        $total_bobot_kemampuan_nsf_taekwondo += $item['bobot_taekwondo'] ?? 0;
        $total_bobot_kemampuan_nsf_canda_birawa += $item['bobot_canda_birawa'] ?? 0;
        $total_bobot_kemampuan_nsf_bela_diri_matahari += $item['bobot_bela_diri_matahari'] ?? 0;
    }

    // Cek untuk Waktu dan NCF
    if ($item['nama_kriteria'] == 'Waktu' && $item['faktor'] == 'NCF') {

        
        $jumlah_ncf_waktu++;
        
        $total_bobot_waktu_ncf_rohis += $item['bobot_rohis'] ?? 0;
        $total_bobot_waktu_ncf_paskibra += $item['bobot_paskibra'] ?? 0;
        $total_bobot_waktu_ncf_pmr += $item['bobot_pmr'] ?? 0;
        $total_bobot_waktu_ncf_pramuka += $item['bobot_pramuka'] ?? 0;
        $total_bobot_waktu_ncf_kabar_15 += $item['bobot_kabar_15'] ?? 0;
        $total_bobot_waktu_ncf_kir += $item['bobot_kir'] ?? 0;
        $total_bobot_waktu_ncf_japanese_club += $item['bobot_japanese_club'] ?? 0;
        $total_bobot_waktu_ncf_osis += $item['bobot_osis'] ?? 0;
        $total_bobot_waktu_ncf_basket += $item['bobot_basket'] ?? 0;
        $total_bobot_waktu_ncf_badminton += $item['bobot_badminton'] ?? 0;
        $total_bobot_waktu_ncf_voli += $item['bobot_voli'] ?? 0;
        $total_bobot_waktu_ncf_sepak_bola += $item['bobot_sepak_bola'] ?? 0;
        $total_bobot_waktu_ncf_futsal += $item['bobot_futsal'] ?? 0;
        $total_bobot_waktu_ncf_seni_suara += $item['bobot_seni_suara'] ?? 0;
        $total_bobot_waktu_ncf_tari_saman += $item['bobot_tari_saman'] ?? 0;
        $total_bobot_waktu_ncf_tari_lenggang_cisadane += $item['bobot_tari_lenggang_cisadane'] ?? 0;
        $total_bobot_waktu_ncf_teater += $item['bobot_teater'] ?? 0;
        $total_bobot_waktu_ncf_taekwondo += $item['bobot_taekwondo'] ?? 0;
        $total_bobot_waktu_ncf_canda_birawa += $item['bobot_canda_birawa'] ?? 0;
        $total_bobot_waktu_ncf_bela_diri_matahari += $item['bobot_bela_diri_matahari'] ?? 0;
    }
    
    // Cek untuk Waktu dan NSF
    elseif ($item['nama_kriteria'] == 'Waktu' && $item['faktor'] == 'NSF') {

        $jumlah_nsf_waktu++;
        
        $total_bobot_waktu_nsf_rohis += $item['bobot_rohis'] ?? 0;
        $total_bobot_waktu_nsf_paskibra += $item['bobot_paskibra'] ?? 0;
        $total_bobot_waktu_nsf_pmr += $item['bobot_pmr'] ?? 0;
        $total_bobot_waktu_nsf_pramuka += $item['bobot_pramuka'] ?? 0;
        $total_bobot_waktu_nsf_kabar_15 += $item['bobot_kabar_15'] ?? 0;
        $total_bobot_waktu_nsf_kir += $item['bobot_kir'] ?? 0;
        $total_bobot_waktu_nsf_japanese_club += $item['bobot_japanese_club'] ?? 0;
        $total_bobot_waktu_nsf_osis += $item['bobot_osis'] ?? 0;
        $total_bobot_waktu_nsf_basket += $item['bobot_basket'] ?? 0;
        $total_bobot_waktu_nsf_badminton += $item['bobot_badminton'] ?? 0;
        $total_bobot_waktu_nsf_voli += $item['bobot_voli'] ?? 0;
        $total_bobot_waktu_nsf_sepak_bola += $item['bobot_sepak_bola'] ?? 0;
        $total_bobot_waktu_nsf_futsal += $item['bobot_futsal'] ?? 0;
        $total_bobot_waktu_nsf_seni_suara += $item['bobot_seni_suara'] ?? 0;
        $total_bobot_waktu_nsf_tari_saman += $item['bobot_tari_saman'] ?? 0;
        $total_bobot_waktu_nsf_tari_lenggang_cisadane += $item['bobot_tari_lenggang_cisadane'] ?? 0;
        $total_bobot_waktu_nsf_teater += $item['bobot_teater'] ?? 0;
        $total_bobot_waktu_nsf_taekwondo += $item['bobot_taekwondo'] ?? 0;
        $total_bobot_waktu_nsf_canda_birawa += $item['bobot_canda_birawa'] ?? 0;
        $total_bobot_waktu_nsf_bela_diri_matahari += $item['bobot_bela_diri_matahari'] ?? 0;
    }

    // Cek untuk Motivasi dan NCF
    if ($item['nama_kriteria'] == 'Motivasi' && $item['faktor'] == 'NCF') {

        
        $jumlah_ncf_motivasi++;
        
        $total_bobot_motivasi_ncf_rohis += $item['bobot_rohis'] ?? 0;
        $total_bobot_motivasi_ncf_paskibra += $item['bobot_paskibra'] ?? 0;
        $total_bobot_motivasi_ncf_pmr += $item['bobot_pmr'] ?? 0;
        $total_bobot_motivasi_ncf_pramuka += $item['bobot_pramuka'] ?? 0;
        $total_bobot_motivasi_ncf_kabar_15 += $item['bobot_kabar_15'] ?? 0;
        $total_bobot_motivasi_ncf_kir += $item['bobot_kir'] ?? 0;
        $total_bobot_motivasi_ncf_japanese_club += $item['bobot_japanese_club'] ?? 0;
        $total_bobot_motivasi_ncf_osis += $item['bobot_osis'] ?? 0;
        $total_bobot_motivasi_ncf_basket += $item['bobot_basket'] ?? 0;
        $total_bobot_motivasi_ncf_badminton += $item['bobot_badminton'] ?? 0;
        $total_bobot_motivasi_ncf_voli += $item['bobot_voli'] ?? 0;
        $total_bobot_motivasi_ncf_sepak_bola += $item['bobot_sepak_bola'] ?? 0;
        $total_bobot_motivasi_ncf_futsal += $item['bobot_futsal'] ?? 0;
        $total_bobot_motivasi_ncf_seni_suara += $item['bobot_seni_suara'] ?? 0;
        $total_bobot_motivasi_ncf_tari_saman += $item['bobot_tari_saman'] ?? 0;
        $total_bobot_motivasi_ncf_tari_lenggang_cisadane += $item['bobot_tari_lenggang_cisadane'] ?? 0;
        $total_bobot_motivasi_ncf_teater += $item['bobot_teater'] ?? 0;
        $total_bobot_motivasi_ncf_taekwondo += $item['bobot_taekwondo'] ?? 0;
        $total_bobot_motivasi_ncf_canda_birawa += $item['bobot_canda_birawa'] ?? 0;
        $total_bobot_motivasi_ncf_bela_diri_matahari += $item['bobot_bela_diri_matahari'] ?? 0;
    }

    // Cek untuk Motivasi dan NSF
    elseif ($item['nama_kriteria'] == 'Motivasi' && $item['faktor'] == 'NSF') {

        
        $jumlah_nsf_motivasi++;
        
        $total_bobot_motivasi_nsf_rohis += $item['bobot_rohis'] ?? 0;
    $total_bobot_motivasi_nsf_paskibra += $item['bobot_paskibra'] ?? 0;
    $total_bobot_motivasi_nsf_pmr += $item['bobot_pmr'] ?? 0;
    $total_bobot_motivasi_nsf_pramuka += $item['bobot_pramuka'] ?? 0;
    $total_bobot_motivasi_nsf_kabar_15 += $item['bobot_kabar_15'] ?? 0;
    $total_bobot_motivasi_nsf_kir += $item['bobot_kir'] ?? 0;
    $total_bobot_motivasi_nsf_japanese_club += $item['bobot_japanese_club'] ?? 0;
    $total_bobot_motivasi_nsf_osis += $item['bobot_osis'] ?? 0;
    $total_bobot_motivasi_nsf_basket += $item['bobot_basket'] ?? 0;
    $total_bobot_motivasi_nsf_badminton += $item['bobot_badminton'] ?? 0;
    $total_bobot_motivasi_nsf_voli += $item['bobot_voli'] ?? 0;
    $total_bobot_motivasi_nsf_sepak_bola += $item['bobot_sepak_bola'] ?? 0;
    $total_bobot_motivasi_nsf_futsal += $item['bobot_futsal'] ?? 0;
    $total_bobot_motivasi_nsf_seni_suara += $item['bobot_seni_suara'] ?? 0;
    $total_bobot_motivasi_nsf_tari_saman += $item['bobot_tari_saman'] ?? 0;
    $total_bobot_motivasi_nsf_tari_lenggang_cisadane += $item['bobot_tari_lenggang_cisadane'] ?? 0;
    $total_bobot_motivasi_nsf_teater += $item['bobot_teater'] ?? 0;
    $total_bobot_motivasi_nsf_taekwondo += $item['bobot_taekwondo'] ?? 0;
    $total_bobot_motivasi_nsf_canda_birawa += $item['bobot_canda_birawa'] ?? 0;
    $total_bobot_motivasi_nsf_bela_diri_matahari += $item['bobot_bela_diri_matahari'] ?? 0;
    }

    // Cek untuk Karakteristik dan NCF
    if ($item['nama_kriteria'] == 'Karakteristik' && $item['faktor'] == 'NCF') {

        
        $jumlah_ncf_karakteristik++;
        
    // Jumlahkan bobot sesuai kolom
    $total_bobot_karakteristik_ncf_rohis += $item['bobot_rohis'] ?? 0;
    $total_bobot_karakteristik_ncf_paskibra += $item['bobot_paskibra'] ?? 0;
    $total_bobot_karakteristik_ncf_pmr += $item['bobot_pmr'] ?? 0;
    $total_bobot_karakteristik_ncf_pramuka += $item['bobot_pramuka'] ?? 0;
    $total_bobot_karakteristik_ncf_kabar_15 += $item['bobot_kabar_15'] ?? 0;
    $total_bobot_karakteristik_ncf_kir += $item['bobot_kir'] ?? 0;
    $total_bobot_karakteristik_ncf_japanese_club += $item['bobot_japanese_club'] ?? 0;
    $total_bobot_karakteristik_ncf_osis += $item['bobot_osis'] ?? 0;
    $total_bobot_karakteristik_ncf_basket += $item['bobot_basket'] ?? 0;
    $total_bobot_karakteristik_ncf_badminton += $item['bobot_badminton'] ?? 0;
    $total_bobot_karakteristik_ncf_voli += $item['bobot_voli'] ?? 0;
    $total_bobot_karakteristik_ncf_sepak_bola += $item['bobot_sepak_bola'] ?? 0;
    $total_bobot_karakteristik_ncf_futsal += $item['bobot_futsal'] ?? 0;
    $total_bobot_karakteristik_ncf_seni_suara += $item['bobot_seni_suara'] ?? 0;
    $total_bobot_karakteristik_ncf_tari_saman += $item['bobot_tari_saman'] ?? 0;
    $total_bobot_karakteristik_ncf_tari_lenggang_cisadane += $item['bobot_tari_lenggang_cisadane'] ?? 0;
    $total_bobot_karakteristik_ncf_teater += $item['bobot_teater'] ?? 0;
    $total_bobot_karakteristik_ncf_taekwondo += $item['bobot_taekwondo'] ?? 0;
    $total_bobot_karakteristik_ncf_canda_birawa += $item['bobot_canda_birawa'] ?? 0;
    $total_bobot_karakteristik_ncf_bela_diri_matahari += $item['bobot_bela_diri_matahari'] ?? 0;
    }

    // Cek untuk Karakteristik dan NSF
    elseif ($item['nama_kriteria'] == 'Karakteristik' && $item['faktor'] == 'NSF') {

        
        $jumlah_nsf_karakteristik++;
        
        $total_bobot_karakteristik_nsf_rohis += $item['bobot_rohis'] ?? 0;
        $total_bobot_karakteristik_nsf_paskibra += $item['bobot_paskibra'] ?? 0;
        $total_bobot_karakteristik_nsf_pmr += $item['bobot_pmr'] ?? 0;
        $total_bobot_karakteristik_nsf_pramuka += $item['bobot_pramuka'] ?? 0;
        $total_bobot_karakteristik_nsf_kabar_15 += $item['bobot_kabar_15'] ?? 0;
        $total_bobot_karakteristik_nsf_kir += $item['bobot_kir'] ?? 0;
        $total_bobot_karakteristik_nsf_japanese_club += $item['bobot_japanese_club'] ?? 0;
        $total_bobot_karakteristik_nsf_osis += $item['bobot_osis'] ?? 0;
        $total_bobot_karakteristik_nsf_basket += $item['bobot_basket'] ?? 0;
        $total_bobot_karakteristik_nsf_badminton += $item['bobot_badminton'] ?? 0;
        $total_bobot_karakteristik_nsf_voli += $item['bobot_voli'] ?? 0;
        $total_bobot_karakteristik_nsf_sepak_bola += $item['bobot_sepak_bola'] ?? 0;
        $total_bobot_karakteristik_nsf_futsal += $item['bobot_futsal'] ?? 0;
        $total_bobot_karakteristik_nsf_seni_suara += $item['bobot_seni_suara'] ?? 0;
        $total_bobot_karakteristik_nsf_tari_saman += $item['bobot_tari_saman'] ?? 0;
        $total_bobot_karakteristik_nsf_tari_lenggang_cisadane += $item['bobot_tari_lenggang_cisadane'] ?? 0;
        $total_bobot_karakteristik_nsf_teater += $item['bobot_teater'] ?? 0;
        $total_bobot_karakteristik_nsf_taekwondo += $item['bobot_taekwondo'] ?? 0;
        $total_bobot_karakteristik_nsf_canda_birawa += $item['bobot_canda_birawa'] ?? 0;
        $total_bobot_karakteristik_nsf_bela_diri_matahari += $item['bobot_bela_diri_matahari'] ?? 0;
                   ...
                   //hitung kriteria akademik untuk nilai ncf dan nsf ipa
                    ...
                    // Menghitung Nilai Rata-Rata Waktu NCF untuk semua ekstrakurikuler
                    // Menghitung Nilai Rata-Rata Waktu NCF untuk semua ekstrakurikuler
if ($jumlah_ncf_waktu != 0) {
    ...
    // Jika jumlah_ncf_waktu adalah 0, tentukan nilai default
    $ncf_waktu_rohis = 0;
    $ncf_waktu_paskibra = 0;
    $ncf_waktu_pmr = 0;
    $ncf_waktu_pramuka = 0;
    $ncf_waktu_kabar_15 = 0;
    $ncf_waktu_kir = 0;
    $ncf_waktu_japanese_club = 0;
    $ncf_waktu_osis = 0;
    $ncf_waktu_basket = 0;
    $ncf_waktu_badminton = 0;
    $ncf_waktu_voli = 0;
    $ncf_waktu_sepak_bola = 0;
    $ncf_waktu_futsal = 0;
    $ncf_waktu_seni_suara = 0;
    $ncf_waktu_tari_saman = 0;
    $ncf_waktu_tari_lenggang_cisadane = 0;
    $ncf_waktu_teater = 0;
    $ncf_waktu_taekwondo = 0;
    $ncf_waktu_canda_birawa = 0;
    $ncf_waktu_bela_diri_matahari = 0;
}

// Menghitung Nilai Rata-Rata Waktu NSF untuk semua ekstrakurikuler
if ($jumlah_nsf_waktu != 0) {
    ...
    // Jika jumlah_nsf_waktu adalah 0, tentukan nilai default
    $nsf_waktu_rohis = 0;
    $nsf_waktu_paskibra = 0;
    $nsf_waktu_pmr = 0;
    $nsf_waktu_pramuka = 0;
    $nsf_waktu_kabar_15 = 0;
    $nsf_waktu_kir = 0;
    $nsf_waktu_japanese_club = 0;
    $nsf_waktu_osis = 0;
    $nsf_waktu_basket = 0;
    $nsf_waktu_badminton = 0;
    $nsf_waktu_voli = 0;
    $nsf_waktu_sepak_bola = 0;
    $nsf_waktu_futsal = 0;
    $nsf_waktu_seni_suara = 0;
    $nsf_waktu_tari_saman = 0;
    $nsf_waktu_tari_lenggang_cisadane = 0;
    $nsf_waktu_teater = 0;
    $nsf_waktu_taekwondo = 0;
    $nsf_waktu_canda_birawa = 0;
    $nsf_waktu_bela_diri_matahari = 0;
}


                    // Menghitung Nilai Rata-Rata Motivasi NCF untuk semua ekstrakurikuler
                    ...
                    // Menghitung Nilai Rata-Rata Motivasi NSF untuk semua ekstrakurikuler
                    ...
                    // Menghitung Nilai Rata-Rata Karakteristik NCF untuk semua ekstrakurikuler
                    ...
                    // Menghitung Nilai Rata-Rata Karakteristik NSF untuk semua ekstrakurikuler
                ...
                $n3_paskibra = ($nsf_waktu_paskibra * 0.4);
                ...
                $n3_pramuka = ($nsf_waktu_pramuka * 0.4);
                ...
                $n3_kabar_15 = ($nsf_waktu_kabar_15 * 0.4);
                ...
                $n3_japanese_club = ($nsf_waktu_japanese_club * 0.4);
                ...
                $n3_basket = ($nsf_waktu_basket * 0.4);
                ...
                $n3_badminton = ($nsf_waktu_badminton * 0.4);
                ...
                $n3_sepak_bola = ($nsf_waktu_sepak_bola * 0.4);
                ...
                $n3_futsal = ($nsf_waktu_futsal * 0.4);
                ...
                $n3_seni_suara = ($nsf_waktu_seni_suara * 0.4);
                ...
                $n3_tari_saman = ($nsf_waktu_tari_saman * 0.4);
                ...
                $n3_tari_lenggang_cisadane = ($nsf_waktu_tari_lenggang_cisadane * 0.4);
                ...
                $n3_teater = ($nsf_waktu_teater * 0.4);
                ...
                $n3_taekwondo = ($nsf_waktu_taekwondo * 0.4);
                ...
                $n3_bela_diri_matahari = ($nsf_waktu_bela_diri_matahari * 0.4);
                ...
                $n3_canda_birawa = ($nsf_waktu_canda_birawa * 0.4);
