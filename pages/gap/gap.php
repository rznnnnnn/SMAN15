...
<li class="nav-item">
    ...
    <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-3 text-right">
                        <button class="btn btn-success" id="btnTambahGap"><i class="fas fa-plus"></i> Tambah Data</button>
                    </div>
            ...
            <!-- Modal Tambah/Edit Nilai GAP -->
            <div class="modal fade" id="modalGap" tabindex="-1" role="dialog" aria-labelledby="modalLabelGap" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form id="form-gap">
                            <div class="modal-header bg-primary text-white">
                                <h5 class="modal-title" id="modalLabelGap">Tambah Nilai GAP</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="gap" id="gap" required placeholder="Masukkan Nilai GAP" min="-999999999" max="999999999" step="0.1" />
                                </div>
                                <div class="form-group">
                                    <label for="bobot">Nilai Bobot</label>
                                    <input type="number" class="form-control" name="bobot" id="bobot" required placeholder="Masukkan Nilai Bobot" min="-999999999" max="999999999" step="0.1" />
                                </div>
                            </div>
...
<!-- End of Footer -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // Tombol Tambah Data Klik
            $("#btnTambahGap").on("click", function () {
                resetForm();
                $("#action").val("");
                $("#modalLabelGap").text("Tambah Nilai GAP");
                $("#modalGap").modal("show");
            });
            ...
            $("#form-gap").on("submit", function (e) {
                ...
                let url = ($("#action").val() == "edit") ? "update-gap.php" : "add-gap.php";
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        var errorMessage = xhr.responseJSON ? xhr.responseJSON.message : "Terjadi kesalahan saat memproses permintaan.";
                        Toast.fire({
                            icon: "error",
                            title: errorMessage,
                        });
            ...
            $(document).on("click", "#btn-edit", function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#action").val("edit");
                        $("#modalLabelGap").text("Edit Nilai GAP");
                        $("#modalGap").modal("show");
                    },
                    error: function () {
